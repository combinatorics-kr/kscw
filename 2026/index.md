...
## Open Problem
- 모든 참석자는 Open problem을 제출해야 합니다.
- 제출하신 Open problem들 중 일부를 선정하여 워크샵 기간동안 함께 논의할 예정이며 해당 문제를 제안해주신 분들께 문제 소개를 요청드릴 수 있습니다.

## 기여 강연 (Contributed talk)
- 발표를 희망하는 분들은 등록 시에 자신의 연구 결과에 대한 강연 초록을 제출할 수 있으며, 제출하신 초록을 바탕으로 강연자를 선정할 예정입니다.
- 강연 시간은 질의응답을 포함하여 40분입니다. -->
<!-- - 대학원생의 경우 초록 제출이 필수입니다. -->
